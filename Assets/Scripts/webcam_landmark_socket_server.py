    ...
    try:
        with mp_pose.Pose(
            ...
            while True:
                ...
                hip_x = (results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_HIP].x + results.pose_landmarks.landmark[
                    mp_pose.PoseLandmark.RIGHT_HIP].x) / 2
                hip_y = (results.pose_landmarks.landmark[mp_pose.PoseLandmark.LEFT_HIP].y + results.pose_landmarks.landmark[
